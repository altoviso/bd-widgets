	...
	tests: [{
		...
		tests: [
			...
			["render", function(){
				...
				let placeholderNode = root.querySelector("div.placeholder");
			...
			["vStat-reflect", function(){
				...
				let input = new TestInput({value:0});
				input.render();
				let root = input.bdDom.root;
			...
			["validation", function(){
				...
				let input = new Input({validateValue: validateValue, format: format, validateText: validateText});
			...
			["input-integer-demo", function(){
				...
				let input = new InputInteger({min:18, max:85, absMin:0, absMax:125});
